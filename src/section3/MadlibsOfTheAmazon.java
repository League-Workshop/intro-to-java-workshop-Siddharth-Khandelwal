...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "If you find yourself having to cross piranha-infested water,here is how to do it...");
...
" and will most likely take a bite \nout of your "+part+" if you "+verb+" . Whatever you do, if you have \nan open wound, try"
		+ " to find another way to get back to \nthe "+place+". Good Luck";
